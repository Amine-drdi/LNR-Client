...
import ListeRdvCommVenteOlivier from './ListeRdvCommVenteOlivier';

function CommercialVenteOlivier() {
...
return () => clearInterval(intervalId);
  ...
  const renderComponent = () => {
    ...
    switch (activeComponent) {
      case 'listeContrats':
        return <ListeRdvCommVenteOlivier />;
      default:
        return <ListeRdvCommVenteOlivier />;
    }
  };
...
export default CommercialVenteOlivier;